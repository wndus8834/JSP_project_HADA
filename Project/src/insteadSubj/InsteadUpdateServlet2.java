...
/**
 * Servlet implementation class InsteadUpdateServlet2
 */

public class InsteadUpdateServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(subjCode.equals("") || subjName.equals("") ||subjInsteadName.equals("") ){
		...
		int result= new InsteadSubjDAO().update(subjCode, subjName, subjInsteadCode, subjInsteadName);
