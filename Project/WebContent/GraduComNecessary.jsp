         ...
         <a class="nav-link dropdown-toggle active" href="Board.jsp" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               ...
               <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle active" href="GraduComNecessary.jsp">컴퓨터공학과</a>
                  <ul class="dropdown-menu">
                     <li><a class="dropdown-item active" href="GraduComNecessary.jsp">졸업 조건</a></li>  
   ...
   <div class="container">
      ...
      <h3 class="mt-2">컴퓨터공학과 졸업요건</h3>
         <table class="table table-hover mx-2 mt-4" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
                <tr>
                   <th rowspan="5"><h5>컴퓨터공학과 학과 학생</h5></th>
                   <td><a class="text-dark">컴퓨터공학과 주전공</a></td>
                ...
                <tr>
                   <td>컴퓨터공학과 (타과)복수전공</td>
                   <td style="text-align: left">전필 포함 40학점 이상 이수</td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>컴퓨터공학과 (타과)부전공</td>
                   <td style="text-align: left">전필 40학점 포함하여 전공 60 학점 이상 이수</td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>컴퓨터공학과 전과</td>
                   <td style="text-align: left">학번에 따라 전공필수 이수<br>
                   전과한 학년/학기부터 들으면 전필 과목이 빠지므로 전선을 더<br>
                   이수하여 전공학점을 채워야 함. 전과한 이후부터 지도과목을 모두<br>
                   이수하여야 함.</td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>컴퓨터공학과 편입</td>
                   <td style="text-align: left">1,2 학년 지도과목은 이수하지 않지만 그 학점만큼의 전필 학점을<br>
                   전선을 더 이수하여 전공학점을 채워야 함.</td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
