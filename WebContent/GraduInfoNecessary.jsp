         ...
         <a class="nav-link dropdown-toggle active" href="Board.jsp" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               ...
               <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle active" href="GraduInfoNecessary.jsp">정보통신공학과</a>
                  <ul class="dropdown-menu">
                     <li><a class="dropdown-item active" href="GraduInfoNecessary.jsp">졸업 조건</a></li>  
   ...
   <div class="container">
      ...
      <h3 class="mt-2">정보통신공학과 졸업요건</h3>
         <table class="table table-hover mx-2 mt-4" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
                <tr>
                   <th rowspan="5"><h5>정보통신공학과 학과 학생</h5></th>
                   <td><a class="text-dark">정보통신공학과 주전공</a></td>
                   <td style="text-align: left">
                   [2014학번 까지] 전공 80학점 이상 이수<br>
                   [2015학번 부터] 전공 71학점 이상 이수<br>
                   </td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>정보통신공학과 (타과)복수전공</td>
                   <td style="text-align: left">
                   [2014학번 까지] 전공 60학점 이상 이수<br>
                   [2015학번 부터] 전공 54학점 이상 이수<br></td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>정보통신공학과 (타과)부전공</td>
                   <td style="text-align: left">
                   [2014학번 까지] 전공 60학점 이상 이수<br>
                   [2015학번 부터] 전공 54학점 이상 이수<br></td>
                   <td>졸업학점 이외의 조건 없음</td>
                ...
                <tr>
                  ...
                  전과하기 이전 학기에 개설된 과정지도, 전공지도 과목은 다른 전공과목으로 대체 가능함.<br></td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>정보통신공학과 편입</td>
                ...
                <tr>
                   ...
                   <td style="text-align: left">
                   [2014학번 까지] 전공 60학점 이상 이수<br>
                   [2015학번 부터] 전공 54학점 이상 이수<br>
                   	전필 중 과정지도, 전공지도는 이수하지 않아도 됨<br></td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
                <tr>
                   <td>정보통신공학과 부전공</td>
                   <td style="text-align: left">전필, 전선 관계없이 21학점</td>
                   <td>졸업학점 이외의 조건 없음</td>
                </tr>
            </tbody>
