      ...
      <li class="nav-item"><!-- active는 현재 위치한 페이지에 넣으면 된다./현재 위치가 파란색으로 표시된다. -->
         ...
         <a class="nav-link dropdown-toggle active" href="Board.jsp" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               ...
               <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle active" href="GraduGlocalNecessary.jsp">글로컬IT학과</a>
                  <ul class="dropdown-menu">
                     <li><a class="dropdown-item active" href="GraduGlocalNecessary.jsp">졸업 조건</a></li>  
   ...
   <div class="container">
      ...
      <h3 class="mt-2">글로컬IT학과 졸업요건</h3>
         <table class="table table-hover mx-2 mt-4" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
                <tr>
                   <th rowspan="5"><h5>글로컬IT학과 학과 학생</h5></th>
                   <td><a class="text-dark">글로컬IT학과 주전공</a></td>
                   <td  rowspan="3" style="text-align: left">  
				                   전공 80학점 이상 이수<br>
			
						([2015학번까지] 전필 45학점 포함,<br>
						
						[2016학번] 전필 43학점 포함,<br>
						
						[2017학번] 전필 40학점 포함)<br>

                   </td>
                   <td rowspan="5" style="text-align: left">
	                  	 해외IT교육, 국내IT전문과정, 타과 부전공 또는 복수전공 중 한 가지 이수<br>
						
						1. 해외IT교육<br>
						
						(1) 인도창과정: IT전공 21학점 이상 이수<br>
						
						(2) 인도창과정 이외 대학이 인정한 해외교육 프로그램 이수(단, 현지에서 이수한<br>
						
						과목은 학과회의에서 전공 인정 여부를 결정)<br>
						
						2. 국내IT실무과정<br>
						
						(1) 인턴십: 학과가 인정한 인턴과정에서 9학점 이상 이수<br>
						
						(2) IT취업실무 과정에서 12학점 이상 이수<br>
						
						(3) 자기설계과정 24학점 이상 이수<br>
						...
						IT자격증 또는 보고서 제출 후 승인<br>
						
						학과 권장 국제공인자격증(OCWCD, MCSD, OCP 등)이나 정보처리기사 등 IT자격증 취득 또는 다음 해당 보고서 제출 후 승인 취득<br>
						
						(1) 해외IT교육(인도창과정): 현지 프로젝트 영문보고서<br>
						
						(2) 국내IT실무과정: 인턴십 결과보고서 또는 취업실무 프로젝트 보고서<br>
						
						(3) 타과 부전공, 복수전공: 졸업 프로젝트 보고서 <br>
						
						(단, 프로젝트 보고서는 자기주도적으로 수행한 부분을 중심으로 단독명의로 작성한 것에 한함.)<br>
						
						  
						
						영어 교양과목 7학점 이상 이수<br>
					</td>
                </tr>
                <tr>
                   <td>글로컬IT학과 전과</td>
                ...
                <tr>
                   <td>글로컬IT학과 (타과)복수전공</td>
                   <td style="text-align: left">전공 40학점 이상 이수<br>
					
					([2015학번까지] 전필 36학점 이상 포함,<br>
					
					[2016학번] 전필 34학점 이상 포함,<br>
					
					[2017학번] 전필 31학점 이상 포함)<br>
					</td>
                </tr>
                <tr>
                   <td>글로컬IT학과 (타과)부전공</td>
                   <td style="text-align: left">전공 60학점 이상 이수<br>
                ...
                <tr>
                   <td rowspan="3"><h5>타과학생</h5></td>
                   <td>글로컬IT학과 복수전공</td>
                   <td style="text-align: left">전공 40학점 이상 이수<br>
					
					(전필 31학점 이상 포함)<br>
					</td>
                   <td style="text-align: left">IT자격증 취득 
					</td>
                </tr>
                <tr>
                   <td>글로컬IT학과 복수전공(공학계)</td>
                   <td style="text-align: left">전공 40학점(전필 8학점, 인도창 IT전공 21학점 포함) 이상 이수 <br>

					(전필 8학점 지정과목: 글로컬입문, 지역IT탐방,
					
					</td>
                   <td style="text-align: left">인도창과정: 원격세미나1, 2 이수 + IT전공 21학점 이상 이수<br>
					
					IT자격증 취득 또는 인도창 현지 프로젝트 <br>
					</td>
                </tr>
                <tr>
                   <td>글로컬IT학과 부전공</td>
                   <td style="text-align: left">전공 21학점 이상 이수<br>
