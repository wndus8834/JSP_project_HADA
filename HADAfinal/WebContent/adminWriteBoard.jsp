...
<div class="container-fluid">
		...
		<li class="nav-item dropdown">
           ...
           <a class="nav-link active dropdown-toggle" id="dropdown" data-toggle="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown">
               <a class="dropdown-item active" href="adminBoard.jsp">공지사항 글쓰기</a>
   ...
   <div class="container">
         ...
         <form method="post" action="Question.jsp"><!-- action 바꿔야함 -->
            ...
            <div class="row">
               <div class="col-12"><input type="submit" class="btn btn-primary float-right" value="글쓰기"></div>
            </div>
         </form>
   </div>
