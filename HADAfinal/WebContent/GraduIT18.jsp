                ...
                <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle active" href="GraduITNecessary.jsp">IT자율 융합학부</a>
                  <ul class="dropdown-menu">
            		<li><a class="dropdown-item" href="GraduITNecessary.jsp">졸업 조건</a></li> 
                     <li><a class="dropdown-item active" href="GraduIT18.jsp">18학번</a></li>
                  </ul>
               </li>
...
%>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <h3 class="mt-2">IT융합 자율학부 2018학번 필수과목</h3>
         ...
         <table class="table table-hover mx-2 mt-4" style="text-align: center; border: 1px solid #dddddd">
            <thead>
               ...
               <tr>
                  <td class="last" style="background-color:#eeeeee; text-align: center;">2018학번</td>
               </tr>
            </thead>
            <tbody>
                <tr>
                   ...
                   <td style="text-align: left">
			            <%
				   		...
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("1") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("1") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("2") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("2") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("3") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("3") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("4") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjGrade().equals("4") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("컴퓨터공학과") && dep.getUserAdmission().equals("2018") && dep.getSubjDivision().equals("교필")){ %>
