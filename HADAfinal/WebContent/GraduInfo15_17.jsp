            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               ...
               <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle active" href="GraduInfoNecessary.jsp">정보통신공학과</a>
                  <ul class="dropdown-menu">
                     ...
                     <li><a class="dropdown-item active" href="GraduInfo15_17.jsp">15~17학번</a></li>
                  </ul>
               </li>
...
%>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <h3 class="mt-2">정보통신공학과 2015~2017학번 필수과목</h3>
         ...
         <table class="table table-hover mx-2 mt-4" style="text-align: center; border: 1px solid #dddddd">
            <thead>
               ...
               <tr>
                  <td class="last" style="background-color:#eeeeee; text-align: center;">2015~2017학번</td>
               </tr>
            </thead>
            <tbody>
                <tr>
                   ...
                   <td style="text-align: left">
			            <%
				   		...
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("1") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("1") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("2") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("2") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("3") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("3") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("4") && dep.getSubjSemester().equals("1학기")&& dep.getSubjDivision().equals("전필")){ %>
			            	...
			            	list=new DepartrDAO().getList();
				   			if(list != null)
				   				for(int i=0; i < list.size(); i++){
				   					DepartrDTO dep = list.get(i);
				   		%>
				   		<%if(dep.getUserDepart().equals("정보통신공학과") && dep.getUserAdmission().equals("2015") && dep.getSubjGrade().equals("4") && dep.getSubjSemester().equals("2학기")&& dep.getSubjDivision().equals("전필")){ %>
