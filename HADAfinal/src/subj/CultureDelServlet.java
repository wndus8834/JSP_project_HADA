...
public class CultureDelServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String coreCapaName = request.getParameter("checkId2");
		String detailAreaName = request.getParameter("checkId3");
	      
	      int result=new SubjDAO().delCapa(coreCapaName, detailAreaName, subjCode);
